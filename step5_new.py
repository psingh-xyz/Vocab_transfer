...
def parse_args():
    ...
    parser.add_argument('--dataset_name', type=str, required=True, default='quora')
    parser.add_argument('--experiment_folder', default='avg')
    parser.add_argument('--sp', default='/thesis/tokenizers/medical_8k/sp.model')
    parser.add_argument('--experiments_dir', default='wiki_medical_8k')
    parser.add_argument('--root_dir', type=str, default='/thesis/models/matched_models/')
    parser.add_argument('--dataset_prefix', type=str, default='/thesis')
...
def main():
    ...
    DATASETS = {
        'quora_dataset': QuoraMLMDataset,
        # 'sentiment': SentimentMLMDataset,
        'hyperpartisan_corrected': HyperpartisanMLMDataset
    }
    ...
    dataset_path = f'{args.dataset_prefix}/{args.dataset_name}'
    print(f"Attempting to load dataset from {dataset_path}")
    dataset = DATASETS[args.dataset_name](dataset_path, sp)
