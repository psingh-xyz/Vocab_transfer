...
def parse_args():
    ...
    parser.add_argument('--dataset_pth', type=str, default='/content/ChangeTokenization/wiki_en.txt')
    parser.add_argument('--snp_path', type=str, default='/content/output.model')  #
    parser.add_argument('--vocab_size', type=int, default=32000)
    parser.add_argument('--save_path', type=str, default='/content/change_tokenization/models/rawBert_rawTokenizer/')
    parser.add_argument('--model_name', type=str, default='Bert_Wiki_32k')
