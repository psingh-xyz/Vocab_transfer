...
from data_utils_new import wikiADataset
...
def parse_args():
    ...
    parser.add_argument('--dataset_pth', type=str, default='/content/thesis/Dataset/en_wiki/en_wiki.txt')
    parser.add_argument('--snp_path', type=str, default='/content/wiki_4k.model')  #
    parser.add_argument('--vocab_size', type=int, default=4000)
    parser.add_argument('--save_path', type=str, default='/content/models/rawBert_rawTokenizer/')
    parser.add_argument('--model_name', type=str, default='Bert_Wiki_4k')
